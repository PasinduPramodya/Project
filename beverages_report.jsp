...
%>
<h2 align="center"><font><strong>Beverages That We Have</strong></font></h2><br><br><br><br>
...
String sql ="SELECT * FROM kwikmart.product where Product_Type like 'b%' or Product_Type like 'B%'";
