...
%>
<h2 align="center"><font><strong>Mobitel Customers That We Have</strong></font></h2><br><br><br><br>
...
String sql ="SELECT * FROM kwikmart.customer where Contact_number like '071%'";
        ...
        $("body").on("click", "#btnExport", function () {
            html2canvas($('#tblCustomers')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("Mobitel Customer.pdf");
                }
            });
        });
    </script>
