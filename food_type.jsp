  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <figure><a class="imgover" href="vegitable_report.jsp"><img src="images/demo/img1.jpg" alt=""></a>
            <figcaption><a href="vegitable_report.jsp"> Vegetable and Fruits  </a></figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><a class="imgover" href="beverages_report.jsp"><img src="images/demo/img22.jpg " alt=""></a>
            <figcaption><a href="beverages_report.jsp"> Beverages</a></figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><a class="imgover" href="dryfood_report.jsp"><img src="images/demo/img321.jpg  " alt=""></a>
            <figcaption><a href="dryfood_report.jsp"> Dry Food  </a></figcaption>
          </figure>
        </li>
      </ul>
    </section>
