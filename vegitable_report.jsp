...
%>
<h2 align="center"><font><strong>Vegetables and Fruits That We Have</strong></font></h2><br><br><br><br>
...
String sql ="SELECT * FROM kwikmart.product where Product_Type like 'v%' or Product_Type like 'f%'";
