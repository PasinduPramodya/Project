  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <br/>
        ...
        <c:forEach var="cus" items ="${stock_Details}">
                                    
                                    
                                     <c:set var="id" value ="${cus.coustomer_id}"/>
                                    <c:set var="fname" value =" ${cus.first_name} "/>
                                    <c:set var="lname" value ="${cus.last_name}"/>
                                    <c:set var="cont" value ="${cus.conact}"/>
                         ...
                         <c:url value="Update_Coustemer.jsp" var="update">          	
    					  
    					  <c:param name ="ID" value="${id}"/>
    					  <c:param name ="FNAME" value="${fname}"/>		
    					  <c:param name ="LNAME" value="${lname}"/>
    					  <c:param name ="CONT" value="${cont}"/>
    					 ...
    					 <c:url value="Delete_Coustemer.jsp" var="delete">          	
