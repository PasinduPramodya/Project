...
%>
<h2 align="center"><font><strong>Dialog Customers That We Have</strong></font></h2><br><br><br><br>
...
String sql ="SELECT * FROM kwikmart.customer where Contact_number like '077%' or Contact_number like '074%' or Contact_number like '076%'";
...
<td><%=resultSet.getString("First_Nmae") %></td>
        ...
        $("body").on("click", "#btnExport", function () {
            html2canvas($('#tblCustomers')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("Dialog Customer.pdf");
                }
            });
        });
    </script>
