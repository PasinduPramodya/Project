 ...
 <div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="comments">
      <center>  <h2>UPDATE STOCK DETAILS </h2></center>
      <br/>
        ...
        <label for="name">Product ID <span>*</span></label>
            <input type="text" name="id" id="id" value="<%= id %>" size="22" readonly><br/><br/>
        
            <label for="name">Product Name <span>*</span></label>
            <input type="text" name="name" id="name" value="<%= Name %>" size="22" required><br/><br/>

           

          
            <label for="text">Product type  <span>*</span></label>
            <input type="text" name="type" id="email" value="<%= Typ %>" size="22" required><br/>
<br/>

          
           
            <label for="url">Product Price <span>*</span></label>
            <input type="text" name="Price" id="url" value="<%= Pri %>" size="22"required><br/>
<br/>

           
         
            <label for="url">Product Supplier ID <span>*</span></label>
            <input type="text" name="Supplyer" id="url" value="<%= Supp %>" size="22"required><br/>
<br/>

          
           
            <label for="url">Number Of  Product  <span>*</span> </label>
            <input type="text" name="Number" id="url" value="<%= Num %>" size="22"required><br/>
<br/>

           
          
            <label for="url">Product Location <span>*</span></label>
            <input type="text" name="Location" id="url" value="<%= Loc %>" size="22"required><br/>
<br/>
          ...
          <div class="block clear">
            ...
            <input type="text" name="DISCRIPTION" id="url" value="<%= Dis %>" size="22"required><br/>
          </div>
          <div><br/>
