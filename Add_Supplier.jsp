    ...
    <div class="content"> 
      ...
      <br/>
        ...
        <form action="addSup" method="post">
            ...
            <input type="text" name="con" id="email" value="" size="22" required><br/>
<br/>

          
           
            <label for="url"> Company Name<span>*</span></label>
            <input type="text" name="comNmae" id="url" value="" size="22" required><br/>
<br/>

           
         
            <label for="url"> Company Address<span>*</span></label>
            <input type="email" name="comPanyADD" id="url" value="" size="22"required><br/>
<br/>
