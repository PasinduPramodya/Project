...
%>
<h2 align="center"><font><strong>Managers That We Have</strong></font></h2><br><br><br><br>
...
String sql ="SELECT * FROM kwikmart.employee where Employee_Position like 'm%' or Employee_Position like 'M%'";
