  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <figure><a class="imgover" href="#"><img src="images/demo/dialog.jpg" alt=""></a>
            <figcaption><a href="Customer_Mobile_number_Dialog_report.jsp"> Dialog</a></figcaption>
          </figure>
        </li>
       <li class="one_third">
          <figure><a class="imgover" href="#"><img src="images/demo/airtel.jpg" alt=""></a>
            <figcaption><a href="Customer_Mobile_number_Airtel_report2.jsp">Airtel</a></figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><a class="imgover" href="#"><img src="images/demo/mobitell.png" alt="" style="width:350px;height:199px;"></a>
            <figcaption><a href="Customer_Mobile_number_Mobitel_report2.jsp">Mobitel</a></figcaption>
          </figure>
        </li>
      </ul>
    </section>
