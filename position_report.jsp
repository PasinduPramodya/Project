  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <figure><a class="imgover" href="manager_report.jsp"><img src="images/demo/manager.jpg" alt=""></a>
            <figcaption><a href="manager_report.jsp"> Manager</a></figcaption>
          </figure>
        </li>
       <li class="one_third">
          <figure><a class="imgover" href="cashier_report.jsp"><img src="images/demo/cashiyer.jpg" alt=""></a>
            <figcaption><a href="cashier_report.jsp">Cashier</a></figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><a class="imgover" href="security_report.jsp"><img src="images/demo/secu44.jpg" alt="" style="width:350px;height:235px;"></a>
            <figcaption><a href="security_report.jsp">Security</a></figcaption>
          </figure>
        </li>
      </ul>
    </section>
