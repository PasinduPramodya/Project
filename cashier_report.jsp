...
%>
<h2 align="center"><font><strong>Employees That We Have</strong></font></h2><br><br><br><br>
...
String sql ="SELECT * FROM kwikmart.employee where Employee_Position like 'c%' or Employee_Position like 'C%'";
