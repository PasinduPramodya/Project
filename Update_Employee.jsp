    ...
    <div class="content"> 
      ...
      <br/>
                                   ...
                                   <%
                                    ...
                                    String lname = request.getParameter("CNUM");
                                    String cot = request.getParameter("POSI");
                                    String email = request.getParameter("DOE");
        ...
        <form action="updateemp" method="post">
            ...
            <input type="text" name="eid" id="id" value="<%= id %>" size="22" readonly><br/><br/>
        
            <label for="name"> Employee Name<span>*</span></label>
            <input type="text" name="name" id="name" value="<%= fName %>" size="22"  ><br/><br/>

           

          
            <label for="text"> Contact Number<span>*</span></label>
            <input type="text" name="cnum" id="type" value="<%= lname %>" size="22"  ><br/><br/>

         
           
            <label for="url">Employee Position<span>*</span></label>
            <input type=" text" name="empos" id="Price" value="<%= cot %>" size="22"  ><br/><br/>

           
         
            <label for="url">Date of entry <span>*</span></label>
            <input type="date" name="doe" id="Supplyer" value="<%= email %>" size="22"  ><br/><br/>
