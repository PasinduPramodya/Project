  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <br/>
        ...
        <c:forEach var="sto" items ="${stock_Details}">
                                    
                                    
                                     <c:set var="id" value ="${sto.product_id}"/>
                                    <c:set var="name" value =" ${sto.name} "/>
                                    <c:set var="price" value ="${sto.price}"/>
                                    <c:set var="type" value ="${sto.type}"/>
                                    <c:set var="number" value ="${sto.number}"/>
                                    <c:set var="location" value ="${sto.location}"/>
                                    <c:set var="supplyer" value ="${sto.supplyer}"/>
                                    <c:set var="DISCRIPTION" value =" ${sto.DISCRIPTION}"/>
                         ...
                         <c:url value="Update_stock.jsp" var="update">          	
    					  
    					  <c:param name ="ID" value="${id}"/>
    					  <c:param name ="NAME" value="${name}"/>		
    					  <c:param name ="PRI" value="${price}"/>
    					  <c:param name ="TYP" value="${type}"/>
    					  <c:param name ="NUM" value="${number}"/>
    					  <c:param name ="LOC" value="${location}"/>
    					  <c:param name ="SUPP" value="${supplyer}"/>
    					  <c:param name ="DIS" value="${DISCRIPTION}"/>
    					   
    					  
    					   
    					  
    					</c:url>     
    					 <c:url value="Delete_stock.jsp" var="delete">          	
