...
%>
<h2 align="center"><font><strong>Suppliers and their Companies</strong></font></h2><br><br><br><br>
...
String sql ="SELECT Supplier_Name,Company_Name FROM kwikmart.supplier";
        ...
        $("body").on("click", "#btnExport", function () {
            html2canvas($('#tblCustomers')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("Supplier.pdf");
                }
            });
        });
    </script>
