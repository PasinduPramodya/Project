 ...
 <div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="comments">
      <center>  <h2> SUPPLIER ACCOUNT </h2></center>
      <br/>
       
       
       
        <c:forEach var="sup" items ="${Supplier_Details}">
                                    
                                          
                                     <c:set var="id" value ="${sup.supplier_ID}"/>
                                    <c:set var="name" value =" ${sup.supplier_Name} "/>
                                    <c:set var="contnum" value ="${sup.contact_Number}"/>
                                    <c:set var="compNam" value ="${sup.company_Name}"/>
                                    <c:set var="compadd" value ="${sup.company_Address}"/>
                              ...
                              <table >      
                                    ...
                                    <td> ${sup.company_Address} </td>
                                    </tr>
                                    		 </table>                             
                                    </c:forEach>
                                    
                                    
                         <c:url value="Update_Supplier.jsp" var="update">          	
    					  
    					  <c:param name ="ID" value="${id}"/>
    					  <c:param name ="NAME" value="${name}"/>		
    					  <c:param name ="tell" value="${contnum}"/>
    					  <c:param name ="comname" value="${compNam}"/>
    					  <c:param name ="comaddre" value="${compadd}"/>
    					   
    					  
    					   
    					  
    					</c:url>     
    					 <c:url value="Delete_Supplier.jsp" var="delete">          	
