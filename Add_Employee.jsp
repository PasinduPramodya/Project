    ...
    <div class="content"> 
      ...
      <br/>
        ...
        <form action="AddEMP" method="post">
            ...
            <input type="text" name="cnum" id="email" value="" size="22"  maxlength="10" pattern="\d{10}$" required><br/>
<br/>

          
           
            <label for="url"> Employee Position <span>*</span></label>
            <input type=" text" name="empos" id="url" value="" size="22" required><br/>
<br/>

           
         
            <label for="url"> Date of entry <span>*</span></label>
            <input type="date" name="doe" id="url" value="" size="22"required><br/>
<br/>
