...
%>
<h2 align="center"><font><strong>Security Personals That We Have</strong></font></h2><br><br><br><br>
...
String sql ="SELECT * FROM kwikmart.employee where Employee_Position like 's%' or Employee_Position like 'S%'";
...
<td><%=resultSet.getString("Employee_Position") %></td>
<td><%=resultSet.getString("Date_of_entry") %></td>
</tr>
