 ...
 <div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="comments">
      <center>  <h2> DELETE  PRODUCT DETAILS </h2></center>
      <br/>
        ...
        <form action="Delet" method="post">
            ...
            <input type="text" name="pid" id="id" value="<%= id %>" size="22" readonly><br/><br/>
        
            <label for="name">Product Name <span>*</span></label>
            <input type="text" name="name" id="name" value="<%= Name %>" size="22" readonly><br/><br/>

           

          
            <label for="text">Product type  <span>*</span></label>
            <input type="text" name="type" id="type" value="<%= Typ %>" size="22" readonly><br/><br/>

         
           
            <label for="url">Product Price <span>*</span></label>
            <input type=" text" name="Price" id="Price" value="<%= Pri %>" size="22" readonly><br/><br/>

           
         
            <label for="url">Product Supplyer ID <span>*</span></label>
            <input type=" text" name="Supplyer" id="Supplyer" value="<%= Supp %>" size="22" readonly><br/><br/>

          
           
            <label for="url">Number Of  Product  <span>*</span> </label>
            <input type=" text" name="Number" id="Number" value="<%= Num %>" size="22" readonly><br/><br/>

           
          
            <label for="url">Product Location <span>*</span></label>
            <input type=" text" name="Location" id="Location" value="<%= Loc %>" size="22" readonly><br/><br/>

           
          
          <div class="block clear">
            <label for="comment">Product Description<span>*</span></label>
            <input type=" text" name="DISCRIPTION" id="DISCRIPTION" value="<%= Dis %>" size="22" readonly><br/>
          </div>
          <div><br/>
