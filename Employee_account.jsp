 ...
 <div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="comments">
      <center>  <h2> EMPLOYEEE ACCOUNT </h2></center>
      <br/>
       
       
       
        <c:forEach var="emp" items ="${Employee_Details}">
                                    
                                    
                                     <c:set var="id" value ="${emp.employee_ID}"/>
                                    <c:set var="name" value =" ${emp.employee_name} "/>
                                    <c:set var="cnum" value ="${emp.contact_number}"/>
                                    <c:set var="pos" value ="${emp.position}"/>
                                    <c:set var="doe" value ="${emp.d_o_e}"/>
                         ...
                         <c:url value="Update_Employee.jsp" var="update">          	
    					  
    					  <c:param name ="ID" value="${id}"/>
    					  <c:param name ="NAME" value="${name}"/>		
    					  <c:param name ="CNUM" value="${cnum}"/>
    					  <c:param name ="POSI" value="${pos}"/>
    					  <c:param name ="DOE" value="${doe}"/>
    					   
    					  
    					   
    					  
    					</c:url>     
    					 <c:url value="Delete_Employee.jsp" var="delete">          	
