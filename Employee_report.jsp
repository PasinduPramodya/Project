  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <figure><a class="imgover" href="#"><img src="images/demo/emp.png" alt=""  style="width:350px;height:199px;"></a>
            <figcaption><a href="Employee_all_details_report2.jsp"> All Employee Details</a></figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><h6>--- -- - - - - - -- - - - - -- - -- - - - -</h6></a>
        ...
        <li class="one_third">
          <figure><a class="imgover" href="position_report.jsp"><img src="images/demo/posi.jpg" alt="" style="width:350px;height:199px;"></a>
            <figcaption><a href="position_report.jsp"> Employee Position Details</a></figcaption>
          </figure>
        </li>
      </ul>
    </section>
