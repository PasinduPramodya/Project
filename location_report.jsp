  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <figure><a class="imgover" href="l1.jsp"><img src="images/demo/l1.png" alt=""  style="width:350px;height:199px;"></a>
            <figcaption><a href="l1.jsp">   Stock  l1   </a></figcaption>
          </figure>
        </li>
       <li class="one_third">
          <figure><a class="imgover" href="l2.jsp"><img src="images/demo/l2.png" alt="" style="width:350px;height:199px;"></a>
            <figcaption><a href="l2.jsp">   Stock  l2  </a></figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><a class="imgover" href="l3.jsp"><img src="images/demo/L3.png" alt=""style="width:350px;height:199px;"></a>
            <figcaption><a href="l3.jsp"> Stock  l3  </a></figcaption>
          </figure>
        </li>
      </ul>
    </section>
