    ...
    <div class="content"> 
      ...
      <br/>
                                   ...
                                   <%
                                    ...
                                    String cot = request.getParameter("CONT");
        ...
        <form action="update_cus" method="post">
         
            <label for="name">ID <span>*</span></label>
            <input type="text" name="Cid" id="id" value="<%= id %>" size="22" readonly><br/><br/>
        
            <label for="name">First Name <span>*</span></label>
            <input type="text" name="F_name" id="name" value="<%= fName %>" size="22"  ><br/><br/>

           

          
            <label for="text">Last Name  <span>*</span></label>
            <input type="text" name="L_name" id="type" value="<%= lname %>" size="22"  ><br/><br/>

         
           
            <label for="url">Contact Number <span>*</span></label>
            <input type=" text" name="CO_NU" id="Price" value="<%= cot %>" size="22"  ><br/><br/>

           
         
            <label for="url">Email <span>*</span></label>
            <input type=" text" name="EMAIL" id="Supplyer" value="<%= email %>" size="22"  ><br/><br/>
