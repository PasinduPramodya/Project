    ...
    <div class="content"> 
      ...
      <br/>
        ...
        <form action="add" method="post">
            ...
            <input type="text" name="name" id="name" value="" size="22" required><br/><br/>

           

          
            <label for="text">Product type  <span>*</span></label>
            <input type="text" name="type" id="email" value="" size="22" required><br/>
<br/>

          
           
            <label for="url">Product Price <span>*</span></label>
            <input type=" text" name="Price" id="url" value="" size="22" required><br/>
<br/>

           
         
            <label for="url">Product Supplier ID <span>*</span></label>
            <input type=" text" name="Supplyer" id="url" value="" size="22"required><br/>
<br/>

          
           
            <label for="url">Number Of  Products  <span>*</span> </label>
            <input type=" text" name="Number" id="url" value="" size="22"required><br/>
<br/>

           
          
            <label for="url">Product Location <span>*</span></label>
            <input type=" text" name="Location" id="url" value="" size="22"required><br/>
<br/>
          ...
          <div class="block clear">
            ...
            <textarea name="DISCRIPTION" id="comment" cols="25" rows="10"required></textarea>
          </div>
          <div><br/>
<br/>
