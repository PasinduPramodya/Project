  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <figure><a class="imgover" href="#"><img src="images/demo/low_stock_details.png" alt=""  style="width:350px;height:199px;"></a>
            <figcaption><a href="Supplier_all_details_report2.jsp"> All Supplier Details</a></figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><h6>--- -- - - - - - -- - - - - -- - -- - - - -</h6></a>
        ...
        <li class="one_third">
          <figure><a class="imgover" href="#"><img src="images/demo/company.jpeg" alt=""></a>
            <figcaption><a href="Supplier_and_product_report.jsp"> Company details</a></figcaption>
          </figure>
        </li>
      </ul>
    </section>
