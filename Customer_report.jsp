  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <figure><a class="imgover" href="#"><img src="images/demo/cus.jpg" alt=""></a>
            <figcaption><a href="Customer_all_details_report.jsp"> All Customer Details</a></figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><h6>--- -- - - - - - -- - - - - -- - -- - - - -</h6></a>
        ...
        <li class="one_third">
          <figure><a class="imgover" href="customer_contactnumber.jsp"><img src="images/demo/tell2.jpg" alt=""></a>
            <figcaption><a href="customer_contactnumber.jsp">Customer's Phone Number</a></figcaption>
          </figure>
        </li>
      </ul>
    </section>
